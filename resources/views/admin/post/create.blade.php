...
@section('content')
    <form action="{{ route('post.store') }}" method="POST" id="newPost">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name="slug" placeholder="Enter Post Slug ..." value="{{ old('slug') }}">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <textarea class="form-control" name="content" id="content" placeholder="Just Write ...">{{ old('content') }}</textarea>
            </div>
        </div>
